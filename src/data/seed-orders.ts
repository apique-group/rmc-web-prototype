...
function mk(n: number, custId: string, day: number, lines: ReturnType<typeof line>[], status: Order['status'] = 'PAID'): Order {
  const c = cust(custId)
  ...
  return {
    id: `GS-202609${String(day).padStart(2, '0')}-${String(n).padStart(4, '0')}`,
    createdAt,
    expiresAt: createdAt,
    status,
    ...
    lines, total, savings,
    consentAt: createdAt,
    verifiedAt: status === 'PAID' ? createdAt : undefined,
  }
}
...
export const SEED_ORDERS: Order[] = [
  ...
  mk(11, 'C-2026-0044', 4, [line('000004', 2)], 'PROOF_UPLOADED'),
  mk(12, 'C-2026-0022', 4, [line('000226', 1)], 'REJECTED'),
]
